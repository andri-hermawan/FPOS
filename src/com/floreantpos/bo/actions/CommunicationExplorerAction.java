...
public class CommunicationExplorerAction extends AbstractAction {

	public CommunicationExplorerAction() {
		super(com.floreantpos.POSConstants.TAX);
	}

	public CommunicationExplorerAction(String name) {
		super(name);
	}

	public CommunicationExplorerAction(String name, Icon icon) {
		super(name, icon);
	}

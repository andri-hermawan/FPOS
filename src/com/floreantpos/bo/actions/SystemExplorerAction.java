...
public class SystemExplorerAction extends AbstractAction {

	public SystemExplorerAction() {
		super(com.floreantpos.POSConstants.TAX);
	}

	public SystemExplorerAction(String name) {
		super(name);
	}

	public SystemExplorerAction(String name, Icon icon) {
		super(name, icon);
	}

...
class LoginPasswordEntryView extends JPanel {
	...
	private void initComponents() {
		...
		setLayout(new MigLayout("ins 0", "[270px,grow]", "[110px][270px][grow,fill][][grow]"));

		buttonPanel.setOpaque(false);
		buttonPanel.setPreferredSize(new java.awt.Dimension(5, 20));
		buttonPanel.setLayout(new MigLayout("", "[60px][60px][60px,grow]", "[10px][10px][10px][10px]"));
		...
		posButton1.setPreferredSize(new java.awt.Dimension(2, 2));
		...
		jPanel3.setLayout(new GridLayout(20, 1, -5, -5));

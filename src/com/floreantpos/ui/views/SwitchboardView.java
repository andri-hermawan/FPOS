...
public class SwitchboardView extends ViewPanel implements ActionListener, ITicketList {
	...
	private void initComponents() {
		setLayout(new java.awt.BorderLayout(100, 100));

		javax.swing.JPanel centerPanel = new javax.swing.JPanel(new java.awt.BorderLayout(2, 2));
		javax.swing.JPanel ticketsAndActivityPanel = new javax.swing.JPanel(new java.awt.BorderLayout(2, 2));
...
//				dialog.open();
	...
	private JPanel createActivityPanel() {
		...
		JPanel innerActivityPanel = new JPanel(new MigLayout("hidemode 3, fill, ins 0", "", ""));

		JPanel panel1 = new JPanel(new GridLayout(0, 10, 10, 10));
...
//                JPanel panel2 = new JPanel(new GridLayout(0, 10, 2, 2));
//                panel2.add(btnSettleTicket);
//                panel2.add(btnCloseOrder);
//                innerActivityPanel.add(panel2);

		final JXCollapsiblePane collapsiblePane = new JXCollapsiblePane();
		collapsiblePane.setAnimated(false);
		collapsiblePane.setLayout(new GridLayout(0, 4, 18, 7));
                //collapsiblePane.setPreferredSize(new Dimension(20, 40));
		collapsiblePane.add(btnGroupSettle);
		collapsiblePane.add(btnSplitTicket);
		collapsiblePane.add(btnReopenTicket);
		collapsiblePane.add(btnVoidTicket);
		collapsiblePane.add(btnRefundTicket);
		collapsiblePane.add(btnAssignDriver);
		collapsiblePane.add(btnCloseOrder);
                
                
                
//                collapsiblePane.setPreferredSize(new Dimension((int)(buttonSize.getWidth() * 9.5)+maxGap,
//                (int)(buttonSize.getHeight() * 9.5)+maxGap * 2));
		...
		//final Border border3 = BorderFactory.createCompoundBorder(BorderFactory.createEmptyBorder(0, 0, 0, 0), btnMore.getBorder());

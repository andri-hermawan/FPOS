...
public class LoginView extends ViewPanel {
	...
	public LoginView() {
		...
		JLabel titleLabel = new JLabel(IconFactory.getIcon("/ui_icons/", ""));
		...
		centerPanel.setBorder(new CompoundBorder(new EtchedBorder(), new EmptyBorder(20, 20, 80, 20)));
		...
		passwordScreen.setBorder(new CompoundBorder(new EtchedBorder(), new EmptyBorder(-10, -5, 999, 5)));

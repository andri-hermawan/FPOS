...
public class TicketView extends JPanel {
	...
	private void initComponents() {
		...
		ticketScrollPane.setPreferredSize(new java.awt.Dimension(80, 100));
		...
		setPreferredSize(new java.awt.Dimension(280, 263));

	}// </editor-fold>                        

	private void createTicketActionPanel() {
		ticketActionPanel.setLayout(new GridLayout(1, 0, 2, 2));
	...
	private JPanel createTotalViewerPanel() {
		...
		tfSubtotal = new javax.swing.JTextField(5);
		...
		tfTax = new javax.swing.JTextField(5);
		...
		tfTotal = new javax.swing.JTextField(5);
		tfTotal.setFont(tfTotal.getFont().deriveFont(Font.BOLD, 16));
		tfTotal.setHorizontalAlignment(SwingConstants.TRAILING);
		tfTotal.setEditable(false);

		JPanel ticketAmountPanel = new com.floreantpos.swing.TransparentPanel(new MigLayout("ins 4 4 5 40,alignx trailing,fill", "[grow][]", ""));
	...
	private void createTicketItemControlPanel() {
		...
		ticketItemActionPanel.setPreferredSize(new Dimension(40, 60));
	}

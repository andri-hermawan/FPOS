...
public class POSConstants {
	...
	public static final String DEVICE_IP = Messages.getString("PosMessage.312"); //$NON-NLS-1$
	public static final String GATEWAY = Messages.getString("PosMessage.313"); //$NON-NLS-1$
	public static final String SERVER_IP = Messages.getString("PosMessage.314"); //$NON-NLS-1$
	public static final String STORAGE = Messages.getString("PosMessage.315"); //$NON-NLS-1$
	public static final String BANNER = Messages.getString("PosMessage.316"); //$NON-NLS-1$
	public static final String MERCHANT_NAME = Messages.getString("PosMessage.317"); //$NON-NLS-1$
	public static final String MERCHANT_TYPE = Messages.getString("PosMessage.318"); //$NON-NLS-1$
	public static final String ADDRESS = Messages.getString("PosMessage.319"); //$NON-NLS-1$
	public static final String AREA = Messages.getString("PosMessage.320"); //$NON-NLS-1$
	public static final String MERCHANT_ID = Messages.getString("PosMessage.321"); //$NON-NLS-1$
	public static final String DEVICE_ID = Messages.getString("PosMessage.322"); //$NON-NLS-1$
	public static final String NAME_USER = Messages.getString("PosMessage.323"); //$NON-NLS-1$
	public static final String EMAIL = Messages.getString("PosMessage.324"); //$NON-NLS-1$
	public static final String CELL_NUMBER = Messages.getString("PosMessage.325"); //$NON-NLS-1$
	public static final String USERNAME = Messages.getString("PosMessage.326"); //$NON-NLS-1$
	public static final String PASSWORD = Messages.getString("PosMessage.327"); //$NON-NLS-1$
	public static final String WIFI = Messages.getString("PosMessage.328"); //$NON-NLS-1$
	public static final String ETHERNET = Messages.getString("PosMessage.329"); //$NON-NLS-1$
	public static final String CELULLAR1 = Messages.getString("PosMessage.330"); //$NON-NLS-1$
	public static final String BRAND1 = Messages.getString("PosMessage.331"); //$NON-NLS-1$
	public static final String CELULLAR2 = Messages.getString("PosMessage.332"); //$NON-NLS-1$
	public static final String BRAND2 = Messages.getString("PosMessage.333"); //$NON-NLS-1$
	public static final String BLOOTOTH = Messages.getString("PosMessage.334"); //$NON-NLS-1$
